...
os.system("pip install -U git+https://github.com/huggingface/transformers.git")
os.system("pip install -U git+https://github.com/huggingface/peft.git")
os.system("pip install -U git+https://github.com/huggingface/accelerate.git")
os.system("pip install -U datasets scipy")
...
# FSDP (Fully Sharded Data Parallel) is a type of data-parallel training that allows us to shard across multiple GPUs.
...
def create_peft_model(model, gradient_checkpointing=True, bf16=True):
    ...
    # Preparing model for sharded training
